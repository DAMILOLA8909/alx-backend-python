...
class UserAdmin(admin.ModelAdmin):
    list_display = ['user_id', 'email', 'first_name', 'last_name', 'role', 'phone_number', 'created_at']
...
class ConversationAdmin(admin.ModelAdmin):
    ...
    search_fields = ['conversation_id', 'participants__user__email', 'participants__user__first_name']
    ordering = ['-created_at']
...
class ConversationParticipantAdmin(admin.ModelAdmin):
    ...
    search_fields = ['conversation__conversation_id', 'user__email', 'user__first_name']
    ordering = ['-joined_at']
